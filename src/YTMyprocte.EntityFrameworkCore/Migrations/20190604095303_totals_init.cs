...
{
    public partial class totals_init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerName = table.Column<string>(maxLength: 32, nullable: true),
                    CustomerTel = table.Column<string>(maxLength: 32, nullable: true),
                    CustomerAddr = table.Column<string>(maxLength: 64, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeleterUserId = table.Column<long>(nullable: true),
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    WaresName = table.Column<string>(maxLength: 100, nullable: true),
                    Code = table.Column<string>(maxLength: 32, nullable: true),
                    WaresType = table.Column<string>(maxLength: 20, nullable: true),
                    WaresFomat = table.Column<string>(nullable: false),
                    WaresUnit = table.Column<string>(maxLength: 20, nullable: true),
                    Manufacturer = table.Column<string>(maxLength: 100, nullable: true),
                    Brands = table.Column<string>(maxLength: 100, nullable: true),
                    SellMoney = table.Column<string>(nullable: true),
                    BuyMoney = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupplierName = table.Column<string>(maxLength: 32, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoodsName = table.Column<string>(maxLength: 32, nullable: true),
                    GoodsUnit = table.Column<string>(maxLength: 32, nullable: true),
                    WaresFomat = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaterielName = table.Column<string>(maxLength: 100, nullable: true),
                    MaterielUnit = table.Column<string>(maxLength: 20, nullable: true),
                    MaterielMoney = table.Column<double>(nullable: false),
                    CurrentAmount = table.Column<int>(nullable: true),
                    CountMoney = table.Column<double>(nullable: false),
                    MinAmount = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonTel = table.Column<string>(nullable: false),
                    SupplierAddr = table.Column<string>(maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
